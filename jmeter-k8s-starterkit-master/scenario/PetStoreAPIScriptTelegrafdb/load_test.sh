...
sh PluginsManagerCMD.sh install-for-jmx PetStoreAPIScriptTelegrafdb.jmx
echo "Done installing plugins, launching test"
jmeter -Ghost= -Gport= -Gprotocol= -Gthreads= -Gduration= -Grampup= --reportatendofloadtests --reportoutputfolder /report/report-PetStoreAPIScriptTelegrafdb.jmx-2024-03-08_095617 --logfile /report/PetStoreAPIScriptTelegrafdb.jmx_2024-03-08_095617.jtl --nongui --testfile PetStoreAPIScriptTelegrafdb.jmx -Dserver.rmi.ssl.disable=true --remoteexit --remotestart 10.36.0.4 >> jmeter-master.out 2>> jmeter-master.err &
...
echo "Starting load test at : Fri Mar  8 09:56:17 UTC 2024" && wait
