...
jmeter -Ghost= -Gport= -Gprotocol= -Gthreads= -Gduration= -Grampup= --reportatendofloadtests --reportoutputfolder /report/report-Test.jmx-2023-11-28_050220 --logfile /report/Test.jmx_2023-11-28_050220.jtl --nongui --testfile Test.jmx -Dserver.rmi.ssl.disable=true --remoteexit --remotestart 10.40.0.3 >> jmeter-master.out 2>> jmeter-master.err &
...
echo "Starting load test at : Tue Nov 28 05:02:20 UTC 2023" && wait
