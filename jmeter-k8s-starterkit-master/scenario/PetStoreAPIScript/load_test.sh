...
sh PluginsManagerCMD.sh install-for-jmx PetStoreAPIScript.jmx
echo "Done installing plugins, launching test"
jmeter -Ghost= -Gport= -Gprotocol= -Gthreads= -Gduration= -Grampup= --reportatendofloadtests --reportoutputfolder /report/report-PetStoreAPIScript.jmx-2024-03-04_075642 --logfile /report/PetStoreAPIScript.jmx_2024-03-04_075642.jtl --nongui --testfile PetStoreAPIScript.jmx -Dserver.rmi.ssl.disable=true --remoteexit --remotestart 10.36.0.4 >> jmeter-master.out 2>> jmeter-master.err &
...
echo "Starting load test at : Mon Mar  4 07:56:42 UTC 2024" && wait
