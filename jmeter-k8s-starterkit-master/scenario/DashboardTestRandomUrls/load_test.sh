...
sh PluginsManagerCMD.sh install-for-jmx DashboardTestRandomUrls.jmx
echo "Done installing plugins, launching test"
jmeter -Ghost= -Gport= -Gprotocol= -Gthreads= -Gduration= -Grampup= --reportatendofloadtests --reportoutputfolder /report/report-DashboardTestRandomUrls.jmx-2023-12-28_084426 --logfile /report/DashboardTestRandomUrls.jmx_2023-12-28_084426.jtl --nongui --testfile DashboardTestRandomUrls.jmx -Dserver.rmi.ssl.disable=true --remoteexit --remotestart 10.36.0.2 >> jmeter-master.out 2>> jmeter-master.err &
...
echo "Starting load test at : Thu Dec 28 08:44:26 UTC 2023" && wait
