...
sh PluginsManagerCMD.sh install-for-jmx PetStoreAPIScriptPluginTestOpenThread.jmx
echo "Done installing plugins, launching test"
jmeter -Ghost= -Gport= -Gprotocol= -Gthreads= -Gduration= -Grampup= --reportatendofloadtests --reportoutputfolder /report/report-PetStoreAPIScriptPluginTestOpenThread.jmx-2024-03-01_132746 --logfile /report/PetStoreAPIScriptPluginTestOpenThread.jmx_2024-03-01_132746.jtl --nongui --testfile PetStoreAPIScriptPluginTestOpenThread.jmx -Dserver.rmi.ssl.disable=true --remoteexit --remotestart 10.36.0.4 >> jmeter-master.out 2>> jmeter-master.err &
...
echo "Starting load test at : Fri Mar  1 13:27:46 UTC 2024" && wait
